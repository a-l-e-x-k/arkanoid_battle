 ...
 * visual interface. The transition effects in fl.external.transitions.easing are defined as a set of
 * transition classes that all extend the base class fl.external.transitions.Transition. You apply
 * external.transitions through an instance of a TransitionManager only; you do not instantiate them
 ...
 */
    ...
    /**
     * @private this was changed from get external.transitions() to get transitionsList() because hitting compile error
     */  	
 ...
 * to which the external.transitions will be applied.
 * @playerversion Flash 9
     * @playerversion AIR 1.0
     * @productversion Flash CS3
     * @langversion 3.0
 ...
 */
  ...
  * transition effect class. For example, the fl.external.transitions.Iris transition effect class requires additional
  ...
  * <code>startPoint</code> and <code>shape</code> parameters that the fl.external.transitions.Iris
  * effect requires. 
...
/**
  ...
  * class. For example, the fl.external.transitions.Iris transition effect class requires additional
  * <code>startPoint</code> and <code>shape</code> parameters. So, in addition to the
  * <code>type</code>, <code>duration</code>, and <code>easing</code> parameters that every
  * transition requires, you would also add (to the <code>transParams</code> object) the 
  * <code>startPoint</code> and <code>shape</code> parameters that the fl.external.transitions.Iris
  ...
  */    
	...
	internal function transitionInDone (e:Object):void 
	{
		...
		if (this.numInTransitions == 0) {
			...
			if (wasVisible) 
			{
				...
				// hidden before the external.transitions actually finished.
    ...
    internal function transitionOutDone(e:Object):void 
	{
		...
		if (this.numOutTransitions == 0) 
		{
			...
			var wasVisible:Boolean = this._content.visible;
			// hide the content when all out external.transitions are done
			if (wasVisible && 
