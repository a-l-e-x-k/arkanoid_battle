...
import mx.external.transitions.*;

TransitionManager.start( this, { type:fl.external.transitions.Iris,
...
/**
 * Sets the tweening effect for the animation. Use one of the effects in the fl.external.transitions or
 * fl.external.transitions.easing packages.
 * @playerversion Flash 9
     * @playerversion AIR 1.0
     * @productversion Flash CS3
     * @langversion 3.0
 ...
 */     
	...
	- additional parameters can be defined for individual external.transitions
	*/	
    ...
    /**
     * @private event that comes from an instance of fl.external.transitions.Tween
     */ 
