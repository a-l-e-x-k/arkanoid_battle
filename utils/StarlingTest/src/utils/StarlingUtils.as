...
package utils
{
	...
	{
		public static function spriteToImage(width:int, height:int, sprite:flash.display.DisplayObject):Image
		{
			var bmd:BitmapData = new BitmapData(width, height, true, 0xFF0000);
			bmd.draw(sprite);
